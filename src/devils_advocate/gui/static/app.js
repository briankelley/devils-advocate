...
const dvad = {
    ...
    _updatePhase(phase, seenPhases) {
        const phaseMap = {
            ...
            'round1_author_responded': 'dot-author',
            'round2_skip': 'dot-rebuttals',
            'round2_skip_reviewer': 'dot-rebuttals',
            'round2_sending': 'dot-rebuttals',
            'round2_calling': 'dot-rebuttals',
            'round2_responded': 'dot-rebuttals',
            'round2_complete': 'dot-rebuttals',
            'round2_author': 'dot-rebuttals',
            'round2_author_calling': 'dot-rebuttals',
            'round2_author_responded': 'dot-rebuttals',
            'round2_skip_context': 'dot-rebuttals',
            'round2_rebuttal_failed': 'dot-rebuttals',
            'round2_author_failed': 'dot-rebuttals',
            'governance_applying': 'dot-governance',
            'governance_catastrophic': 'dot-governance',
            'governance_complete': 'dot-governance',
            'cost_warning': null,
            'cost_exceeded': null,
            'revision_generating': 'dot-revision',
            'revision_duration_estimate': 'dot-revision',
