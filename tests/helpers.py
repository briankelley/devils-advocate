"""Reusable factory helpers for test data construction.

These are plain functions (not pytest fixtures) used across unit and E2E tests.
Extracted from conftest.py to avoid bare ``from conftest import`` collisions
when pytest collects from both ``tests/`` and ``tests/e2e/``.
"""
